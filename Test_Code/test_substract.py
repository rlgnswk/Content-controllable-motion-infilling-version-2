...
def main(args):
    ...
    for iternum, item in enumerate(valid_dataloader):
        ...
        masked_input, gt_image, blend_part, blend_gt, blend_part_only, blend_part2, blend_part_only2 = item
        ...
        blend_part2 = blend_part2.to(device, dtype=torch.float)
        blend_part_only2 = blend_part_only2.to(device, dtype=torch.float)
        ...
        with torch.no_grad():
            if iternum%100 == 0:
                ...
                sub_output12, sub_output21 = model.test_substract(masked_input, blend_part_only, blend_part_only2, args.batchSize)
                saveUtils.save_result_substract(sub_output12, sub_output21, blend_part, blend_part2)
