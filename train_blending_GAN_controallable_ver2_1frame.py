...
import models_blend_controllable_ver2_1frame as models

import utils4blend as utils
import data_load_blend_ver2_1frame as data_load
...
def main(args):
    ...
    saveUtils.save_log(str(summary(model, ((1,1,69,240), (1,1,69,1)))))
