...
if __name__ == '__main__':
    ...
    #db_Input = 'epoch_'+str(epoch)+'_Masked_input.npy'
    TestOutput_blend_part1 = 'TestOutput_blend_part1.npy'
    TestOutput_blend_part2 = 'TestOutput_blend_part2.npy'
    TestOutput_sub_output12 = 'TestOutput_sub_output12.npy'
    TestOutput_sub_output21 = 'TestOutput_sub_output21.npy'
    
    database_input= np.load(os.path.join(data_path, db_input))
    #print(database.shape)
    database_input = add_foot_contacts(database_input)
  
    database_TestOutput_blend_part1= np.load(os.path.join(data_path, TestOutput_blend_part1))
    #print(database.shape)
    database_TestOutput_blend_part1 = add_foot_contacts(database_TestOutput_blend_part1)
  
    database_TestOutput_blend_part2= np.load(os.path.join(data_path, TestOutput_blend_part2))
    #print(database.shape)
    database_TestOutput_blend_part2 = add_foot_contacts(database_TestOutput_blend_part2)  

    database_TestOutput_sub_output12= np.load(os.path.join(data_path, TestOutput_sub_output12))
    #print(database.shape)
    database_TestOutput_sub_output12 = add_foot_contacts(database_TestOutput_sub_output12) 

    database_TestOutput_sub_output21= np.load(os.path.join(data_path, TestOutput_sub_output21))
    #print(database.shape)
    database_TestOutput_sub_output21 = add_foot_contacts(database_TestOutput_sub_output21) 

    for i in range(20):
        index0 = np.random.randint(0, len(database_input))
        ...
        animation_plot([
            ...
            database_TestOutput_blend_part1[index0:index0 + 1],
            database_TestOutput_blend_part2[index0:index0 + 1],
            database_TestOutput_sub_output12[index0:index0 + 1],
            database_TestOutput_sub_output21[index0:index0 + 1],           
        ])
