...
parser.add_argument('--std', type=int, default=1.0) 
...
if __name__ == '__main__':
    ...
    db_Results_rand_100 = 'TestOutput_mean'+str(args.mu)+'_var'+str(100)+'.npy'
    db_Results_rand_50 = 'TestOutput_mean'+str(args.mu)+'_var'+str(50)+'.npy'
    db_Results_rand_10 = 'TestOutput_mean'+str(args.mu)+'_var'+str(10)+'.npy'
    db_Results_rand_5 = 'TestOutput_mean'+str(args.mu)+'_var'+str(1)+'.npy'
    db_Results_rand_0 = 'TestOutput_mean'+str(args.mu)+'_var'+str(0.1)+'.npy'
    db_Results_rand5 = 'TestOutput_mean'+str(args.mu)+'_var'+str(0.01)+'.npy'
    db_Results_rand10 = 'TestOutput_mean'+str(args.mu)+'_var'+str(0.001)+'.npy'
    db_Results_rand50 = 'TestOutput_mean'+str(args.mu)+'_var'+str(0.0001)+'.npy'
